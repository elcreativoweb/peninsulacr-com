...
(function ($) {
    ...
    houzez.Core = (function () {
        ...
        const util = {
            ...
            showSuccess: function (target, message) {
                const $target = typeof target === 'string' 'string' '');

                // Parsing to number
                const parsedValue = parseFloat(cleanedValue);

                // if parsedValue is NaN, return 0, otherwise return the parsed number
                return isNaN(parsedValue) 'sortby') {
        ...
        const is_mobile = () => {
            ...
            // 2. modern UAData
            if (navigator.userAgentData"tooltip"]')
            );
        ...
        const listingViewSwitch = function () {
            ...
            $('.listing-switch-view .switch-btn, .switch-btn').on(
                ...
                function (e) {
                    e.preventDefault();
                    var view = $(this).hasClass('btn-grid') "resize", checkCollapse);
    ...
    houzez.Compare = (function () {
        ...
        function add_to_compare(
            ...
            var listings_compare = storedData 'a.compare-btn').attr(
                'href',
                compare_url +
                    '"' +
        ...
        function remove_from_compare(
            ...
            $('.remove-compare')
                ...
                .on('click', function (e) {
                    ...
                    listings_compare = storedData 'listing_id');
    ...
    houzez.Search = (function () {
        ...
        const fillDistanceRangeSlider = function (slider) {
            ...
            const direction = isRTL "${unique_id}"]`
            );
            ...
            const fillSlider = (
                ...
                const isRTL = document.documentElement.dir === 'rtl';
                const direction = isRTL "list-group"><li class="list-group-item"><i class="fa fa-spinner fa-spin fa-fw"></i> ' +
            ...
            $('.reset-search-btn').on('click', function (e) {
                ...
                if (distanceSlider && distanceInput) {
                    ...
                    if (typeof fillDistanceRangeSlider === 'function') {
                        ...
                        const isRTL = document.documentElement.dir === 'rtl';
                        const direction = isRTL "radius"]').val(defaultRadius);
                }
            ...
            jQuery(megaMenuSelector).each(function () {
                ...
                // Case 2: Custom width
                    ...
                    if ($navItem.length > 0) {
                        ...
                        parentOffset = parentOffset "houzez-overlay-loading">' +
